...
KeyboardLayout {
    ...
    KeyboardRow {
        ...
        CharacterKey { caption: "水"; captionShifted: "E"; symView: "3"; symView2: "$" }
        CharacterKey { caption: "口"; captionShifted: "R"; symView: "4"; symView2: "¥" }
        CharacterKey { caption: "廿"; captionShifted: "T"; symView: "5"; symView2: "₹" }
        CharacterKey { caption: "卜"; captionShifted: "Y"; symView: "6"; symView2: "%" }
        CharacterKey { caption: "山"; captionShifted: "U"; symView: "7"; symView2: "<" }
        CharacterKey { caption: "戈"; captionShifted: "I"; symView: "8"; symView2: ">" }
        CharacterKey { caption: "人"; captionShifted: "O"; symView: "9"; symView2: "[" }
        CharacterKey { caption: "心"; captionShifted: "P"; symView: "0"; symView2: "]" }
    }

    KeyboardRow {
        CharacterKey { caption: "日"; captionShifted: "A"; symView: "*"; symView2: "`" }
        CharacterKey { caption: "尸"; captionShifted: "S"; symView: "#"; symView2: "^" }
        CharacterKey { caption: "木"; captionShifted: "D"; symView: "+"; symView2: "|" }
    ...
    KeyboardRow {
        ...
        CharacterKey { caption: "金"; captionShifted: "C"; symView: "/"; symView2: "\" }
        CharacterKey { caption: "女"; captionShifted: "V"; symView: "\\"; symView2: "“" }
        CharacterKey { caption: "月"; captionShifted: "B"; symView: "'"; symView2: "”" }
        CharacterKey { caption: "弓"; captionShifted: "N"; symView: ";"; symView2: "„" }
